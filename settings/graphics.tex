...
\usetikzlibrary{calc, shapes, intersections, backgrounds, decorations.markings, decorations.text, tikzmark, angles, matrix, quotes, hobby} % lib quotes is for being able to pass labels in quotes to pics. yeah.
\tikzset{
	%% Styles %%
