...
\newcommand{\fromtranstomat}[6]{
	\begin{tikzpicture}[ampersand replacement=\&]
		...
		\draw[thick, dotted, black!25] (-2,-2.1) -- ++(4,0) node[midway, fill=white, text=xblue] (T) {$#1$};
		...
		\draw[mapstoarrow] (e1col.south) -- (e1map.north);
		\draw[mapstoarrow] (e2col.south) -- (e2map.north);
