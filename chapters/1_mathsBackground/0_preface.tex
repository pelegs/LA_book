	...
	\begin{center}
		\begin{tikzpicture}
			\begin{axis}[
				...
				\draw[vector, xred] (1,0) -- (2,0);
				\draw[vector, xred] (2,0) -- (3,0);

				\draw[vector, xblue] (3,0) -- (3,1);
				\draw[vector, xblue] (3,1) -- (3,2);
				\draw[vector, xblue] (3,2) -- (3,3);
			\end{axis}
			\begin{axis}[
					xyplane,
					anchor=origin,
					at={(stdbasis)}, xshift=7cm,
					width=7cm, height=7cm,
					grid=major,
					major grid style={black!5},
					xtick={-5,-4,...,5},
				...
				\draw[vector, xgreen] (0,0) -- (B1);
				\draw[vector, xpurple] (0,0) -- (B2);

				\draw[vector, xgreen] (0,0) -- ($-1*(B1)$);
				% \draw[vector, xgreen] (B1) -- ($(B1)+(B2)$);
			\end{axis}
		\end{tikzpicture}
	\end{center}
	\caption{}
